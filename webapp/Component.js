sap.ui.define(
	...
	function(UIComponent){
		return UIComponent.extend("fiori.sap.sv.Component",{
			metadata: {
				manifest: "json"
			},
			init: function(){
			...
			// 		viewName: "fiori.sap.sv.view.App",
			// 		type: "XML"
			// 	});
			...
			// 		viewName: "fiori.sap.sv.view.View1",
			// 		type: "XML"
			// 	});
			
			// 	var oView2 = new sap.ui.view("idView2",{
			// 		viewName: "fiori.sap.sv.view.View2",
			// 		type: "XML"
			// 	});
			// 	var oEmpty = new sap.ui.view("idEmpty",{
			// 		viewName: "fiori.sap.sv.view.Empty",
			// 		type: "XML"
			// 	});
